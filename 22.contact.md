...
| `name` |champ obligatoire, qui bloquera l'envoi s'il n'est pas rempli correctement |
| `required` | texte de description pour un champ de saisie unique
| `placeholder` | nom du champ de saisie qui sera soumis lors de l'envoi du formulaire |
...
[#](#contact-markup) :hand: Contact Markup 
-------------------------------------------
