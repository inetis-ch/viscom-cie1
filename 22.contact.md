...
[#](#styles de contact) Tâche de styles de contact
-------------------------------------------
...
Pour que votre formulaire ait une bonne apparence, vous avez besoin du CSS approprié.
    ...
    */
    ...
    .form label {
    	taille de la police : 0,85rem ;
    }
    
    .form_input {
    	rembourrage : 1rem ;
    	marge : 0,5rem 0 1rem 0 ;
    ...
    .form_input::placeholder {
    	couleur : rgba(2,54,94,0.5) ;
    }
    
    .form_submit {
    	s'aligner : centre ;
    	rembourrage : 1,25rem 3,5rem ; /* haut/bas 1,25rem et gauche/droite 3,5rem */
    	marge : 1rem 0 ;
    	rayon de la frontière : 10rem ;
...
! [section contact](/assets/img/contact.b38659f0.png)
...
[#19 Select Dropdown](/challenges/#_19-select-dropdown) (Ajouter un menu déroulant avec des choix au formulaire)
