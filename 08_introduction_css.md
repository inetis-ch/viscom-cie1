# 8. Introduction au CSS

## [#](08\_introduction\_css.md#syntaxe) Syntaxe
...
:memo: Notation correcte Après une propriété, il doit toujours y avoir un deux-points `:` et après la valeur un point-virgule `;`.

## [#](08\_introduction\_css.md#interplay-with-html) Interaction avec le HTML
...
## [#](08\_introduction\_css.md#sélecteurs) Sélecteurs
...
### [#](08\_introduction\_css.md#tag-selector) Tag Selector
...
### [#](08\_introduction\_css.md#id-selector) ID selector
...
:thumbsup: En CSS, un ID a toujours un dièse "#" devant le sélecteur. En HTML, vous n'écrivez pas ce hachage. HTML: `my-id`, CSS: `#my-id`.

## [#](08\_introduction\_css.md#selecteurs-combine) Combiner les sélecteurs

### [#](08\_introduction\_css.md#tags-mit-classes) Étiquettes avec classes
...
### [#](08\_introduction\_css.md#multiple-classes) Multiple Classes
...
### [#](08\_introduction\_css.md#spécificité) Spécificité
...
### [#](08\_introduction\_css.md#héritage) Héritage
...
### [#](08\_introduction\_css.md#cascade) Cascade
...
### [#](08\_introduction\_css.md#differences-between-content-box-and-border-box) Différences entre content-box et border-box
...
#### \[#] Pourquoi les boîtes sont-elles de largeur différente ?
...
| ---------- | ---------------------------------------------------------------------------------- |
| `display`  | layout behavior of elements. Plus: [Mise en page CSS](guide/09\_css\_layout/)      |
| `position` | positionnement des éléments. Plus: [Positionnement et chemins](guide/11\_chemins/) |
...
* [Jeux CSS](https://flukeout.github.io/)
