...
Node.js est un logiciel à code source ouvert (disponible gratuitement) permettant de construire une l'environnement du serveur. Comme surge.sh ne fonctionnera pas sans Node.js, vous devez l'installer sur votre appareil.
...
Entrez maintenant votre **email et choisissez un mot de passe** que vous souhaitez utiliser pour votre compte surge.sh.
...
* [#27 Git Deployment](/viscom-cie1/challenges/#_27-git-deployment) (Publiez votre site web avec Git)
