...
Netlify Drop Homepage](/assets/img/netlify-1.a1033e24.png)
...
![Git Branches](/assets/img/git-branches.664e8633.png) Image : [Noble Desktop](https://www.nobledesktop.com/learn/git/git-branches)
...
![nodejs](/assets/img/nodejs.410ec09a.png)Télécharger Node.js LTS.

![nodejs](/assets/img/node_install.f185ff14.png) Effectuer l'installation.
...
![surge.sh](/assets/img/surge.7b1c9672.png) Le terminal devrait ressembler à ceci après toutes les étapes.
