...
[Premier iPhone](/assets/img/iphone.6d763eb0.jpg) Le premier iPhone. Image : Pomme
...
! [unités relatives](/assets/img/relative_units.4620927c.gif) Image [FROONT](https://blog.froont.com/9-basic-principles-of-responsive-web-design/)
...
![responsive adaptive](/assets/img/responsive_adaptive.fac5fc66.gif) Image [FROONT](https://blog.froont.com/9-basic-principles-of-responsive-web-design/)
...
! [bureau mobile](/assets/img/mobile_desktop.fd832396.gif) Image [FROONT](https://blog.froont.com/9-basic-principles-of-responsive-web-design/)
...
! [breakpoints](/assets/img/breakpoints.30d98cae.gif) Image [FROONT](https://blog.froont.com/9-basic-principles-of-responsive-web-design/)
...
Une fois que vous avez créé ce fichier et que vous l'avez lié dans le HTML, vous pouvez y placer les styles suivants :
    ...
    @media (largeur maximale : 60em){
      ...
      */
      ...
      .about_image {
        rayon de la frontière : 0 ; /* pas de coins arrondis sur l'image */
