...
´´´css
    ...
    */
    ...
    nav a {
      ...
      display  : bloc en ligne ; /* Tous les liens dans la navigation peuvent être espacés, mais sont côte à côte (modèle de boîte de principe, nous y reviendrons plus tard)*/
      color : #02365E ; /* set font */
    }
