...
## [#](29.fin.md#présentation) Présentation
...
Vous avez travaillé sur tous les chapitres et avez réussi le cours. Peut-être avez-vous également réussi à résoudre certains [défis](d%C3%A9fis/) ? Nous espérons que vous avez apprécié le cours et que vous en retirerez de nouvelles connaissances qui vous aideront dans votre parcours professionel.

## [#](29.fin.md#feedback) Feedback
...
## [#](29.fin.md#accessibilité-accessibilité) Accessibilité (Accessibilité)
...
* [Le guide définitif du référencement en 2021](https://backlinko.com/seo-this-year)

## [#](29.fin.md#coding-workflow) Outils et organisation du travail

Il existe de nombreux petits outils et aides qui vous facilitent le codage de site plus ou moins complexe.

### [#](29.fin.md#editor-plugins) Plugins de l'éditeur
...
### [#](29.fin.md#git-versioning) Git (Versioning)
...
## [#](29.fin.md#ressources) Ressources

### [#](29.fin.md#code-examples-inspiration) Exemples de codes et inspiration.
...
### [#](29.fin.md#coding-help) Trouver de l'aide
...
### [#](29.fin.md#learn-tutorials) Apprentissage et tutoriaux
